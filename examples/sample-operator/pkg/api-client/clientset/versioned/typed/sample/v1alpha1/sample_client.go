...
// SampleV1alpha1Client is used to interact with features provided by the sample.lifecycle.kubevirt.io group.
type SampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SampleV1alpha1Client) SampleConfigs() SampleConfigInterface {
	return newSampleConfigs(c)
}
