...
export KUBEVIRT_PROVIDER=${KUBEVIRT_PROVIDER:-'k8s-1.29'}
export KUBEVIRTCI_VERSION=${KUBEVIRTCI_VERSION:-'2402231446-3191285'}
export KUBEVIRTCI_TAG=2402231446-3191285
